...
@onready var mist_system: MistPaintingSystem = %MistPaintingSystem
...
func _initialize_game() -> void:
    ...
    AutoLoad.game_state.change_state(GameStateManager.GameState.PLAYING)
...
func _on_mist_coverage_changed(coverage: float) -> void:
    # 更新UI显示迷雾覆盖率
    var coverage_label = $UILayer/GameUI/TopBar/MistCoverageLabel
    if coverage_label:
...
func pause_game() -> void:
    ...
    AutoLoad.game_state.change_state(GameStateManager.GameState.PAUSED)
...
func end_level(success: bool) -> void:
    ...
    if success:
        AutoLoad.game_state.change_state(GameStateManager.GameState.LEVEL_COMPLETE)
        ...
        AutoLoad.game_state.change_state(GameStateManager.GameState.GAME_OVER)
